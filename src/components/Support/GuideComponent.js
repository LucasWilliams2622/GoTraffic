...
export const GuideType3 = () => {
    return (
        <ScrollView
            ...
            <Text style={[{ fontSize: 24, color: COLOR.forth, fontWeight: '500', marginTop: 20, alignSelf: 'center' }]}>Thanh toán trực tiếp - Ví điện tử</Text>
            ...
            <Text style={[{ fontSize: 24, color: COLOR.forth, fontWeight: '500', marginTop: 20, alignSelf: 'center' }]}>Nạp tiền vào ví - Đặt cọc dễ dàng</Text>
            <FastImage
                resizeMode='stretch'
                style={{ width: '100%', height: windowHeight * 0.27, borderRadius: 8, marginVertical: 10 }}
                source={require('../../assets/image/balance.png')}
            />
            <Text style={[appStyle.text16, { textAlign: 'left' }]}>
                Bạn có thể dễ dàng nạp/rút tiền về tài khoản ngân hàng của mình
                một cách nhanh chóng. Có thể xem lịch sử giao dịch trên ứng dụng
                để đảm bảo nguồn tiền của mình
            </Text>
    ...
    return (
        <ScrollView
            ...
            <View style={{ marginTop: 15 }}>
                ...
                <View>
                    <Text style={{ fontSize: 18, fontWeight: '500' }}>A. Kiểm tra thông tin xe</Text>
                ...
                <View style={{ marginTop: 5 }}>
                    <Text style={{ fontSize: 18, fontWeight: '500' }}>B. Kiểm tra yêu cầu giấy tờ thuê xe và xem thông tin chủ xe:</Text>
                    <Text style={[appStyle.text16, { lineHeight: 18 }]}>
                ...
                <View style={{ marginTop: 5 }}>
                    <Text style={{ fontSize: 18, fontWeight: '500' }}>C. Kiểm tra giá, thời gian thuê, địa điểm giao nhận xe</Text>
                    <Text style={[appStyle.text16, { lineHeight: 18 }]}>
            ...
            <View style={{ marginTop: 15 }}>
                ...
                <Text style={[appStyle.text16, { lineHeight: 18 }]}>Bạn sẽ được nhận thông báo phản hồi yêu cầu thuê xe của bạn có được duyệt hay không</Text>
            </View>
    ...
    return (
        <ScrollView
            ...
            <View>
                ...
                <FastImage resizeMode='stretch' style={{ width: '58%', height: windowHeight * 0.2, alignSelf: 'center' }} source={require('../../assets/image/logo_go_traffic.png')} />
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 24, color: COLOR.primary, fontWeight: '500', textAlign: 'center' }}>
                    Chào mừng đến với GoTraffic!
                </Text>
                <Text style={{ fontSize: 16, color: COLOR.forth, fontWeight: '500', textAlign: 'center' }}> Nơi Kết Nối Thuận Lợi Giữa Người Thuê và Chủ Xe</Text>
                <View style={{ marginTop: 5 }}>
                    <Text style={[appStyle.text16, { lineHeight: 18 }]}>
                        • GoTraffic tự hào là đối tác đáng tin cậy trong lĩnh vực cho thuê xe hơi, đem lại
                        trải nghiệm độc đáo và thuận lợi cho cả người thuê và chủ xe. Chúng tôi cung cấp
                        một nền tảng hiện đại, nơi mà việc tìm kiếm và đăng ký xe trở nên dễ dàng và nhanh chóng.
                    </Text>
                </View>
            ...
            <View style={{ marginTop: 15 }}>
                <Text style={[appStyle.text16, { lineHeight: 18 }]}>
                    •  Với GoTraffic, người dùng không chỉ có cơ hội tận hưởng những chuyến đi thoải mái
                    với các loại xe đa dạng và giá cả hợp lý, mà còn có thể trở
                    thành chủ xe thông qua việc đăng ký xe cá nhân. Điều này mở ra
                    cơ hội kiếm thêm thu nhập một cách linh hoạt và tiện lợi.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={[appStyle.text16, { lineHeight: 18 }]}>
                    •  Đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng giải đáp mọi thắc mắc và hỗ trợ bạn trong mọi
                    chuyến đi. Hãy đồng hành cùng GoTraffic để trải nghiệm sự thuận lợi và an toàn trên mỗi hành trình!
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={[appStyle.text16, { lineHeight: 18 }]}>
                    Chào mừng bạn đến với gia đình GoTraffic - Nơi Chất Lượng và Tiện Nghi Gặp Gỡ!
                </Text>
            </View>
...
export const GuideType5 = () => {
    return (
        <ScrollView
            ...
            <View>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>1. Bảo Mật và Quyền Riêng Tư:</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    Chúng tôi cam kết bảo vệ thông tin cá nhân của bạn. Mọi dữ liệu cá nhân sẽ được
                    quản lý chặt chẽ và chỉ sử dụng với mục đích cung cấp dịch vụ và nâng cao trải nghiệm người dùng.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>2. Chính Sách Hủy Đặt:</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    Chính sách hủy đặt của chúng tôi được xây dựng để đảm bảo sự linh hoạt và công bằng
                    cho cả người thuê và chủ xe. Bạn có thể tìm hiểu chi tiết về chính sách hủy đặt trên
                    trang web của chúng tôi.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>3. An Toàn và Bảo Hiểm:</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    Chúng tôi chú trọng đến an toàn. Cả người thuê và chủ xe đều được khuyến khích thực
                    hiện các biện pháp an toàn và tuân thủ các quy tắc giao thông. Ngoài ra, chúng tôi
                    cung cấp các tùy chọn bảo hiểm để đảm bảo mọi bên đều được bảo vệ.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>4. Chấp Nhận và Điều Kiện Sử Dụng:</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    Để sử dụng dịch vụ của chúng tôi, vui lòng đọc và hiểu rõ các điều kiện sử dụng. Việc sử dụng
                    dịch vụ của chúng tôi đồng nghĩa với việc bạn chấp nhận và tuân thủ theo những điều kiện này.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={[appStyle.text16, { lineHeight: 20 }]}>
                    Chúng tôi luôn lắng nghe và hoan nghênh mọi phản hồi từ bạn để cải thiện dịch vụ.
                    Hãy liên hệ với chúng tôi nếu bạn có bất kỳ câu hỏi hoặc đề xuất nào.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>Cảm ơn bạn đã tin tưởng và sử dụng dịch vụ của GoTraffic!</Text>
            </View>
        </ScrollView>
    )
}
...
export const GuideType6 = () => {
    return (
        <ScrollView
            ...
            shouldRasterizeIOS
            showsVerticalScrollIndicator={false}>
            <FastImage resizeMode='stretch' style={{ width: '100%', height: windowHeight * 0.2, borderRadius: 8 }} source={require('../../assets/image/bgCar2.jpg')} />

            <Text style={{ fontSize: 24, color: COLOR.fifth, fontWeight: '500', marginTop: 10 }}>
                Câu hỏi thường gặp
            </Text>
            <Text style={[appStyle.text16, { lineHeight: 20, margin: 10, textAlign: 'justify' }]}>
                Chào mừng bạn đến với trang Câu Hỏi và Trả Lời của GoTraffic! Dưới đây là một số
                câu hỏi phổ biến mà chúng tôi đã tổng hợp để giúp bạn hiểu rõ hơn về dịch vụ của chúng tôi.
            </Text>
            <View>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>1. Làm thế nào để thuê xe trên GoTraffic?</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
            ...
            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>2. Làm thế nào để đăng ký xe cho thuê?</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    Chủ xe có thể đăng ký xe trên ứng dụng GoTraffic bằng cách cung cấp
                    thông tin chi tiết về xe và tuân thủ các yêu cầu về an toàn và chất lượng.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>3. Làm thế nào để đảm bảo an toàn khi sử dụng dịch vụ?</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    GoTraffic có các biện pháp an toàn như kiểm tra độ an toàn của xe, hỗ trợ
                    đường trực tuyến, và tùy chọn bảo hiểm cho cả người thuê và chủ xe.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}>4. Làm thế nào để hủy đặt xe đã đặt?</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    Bạn có thể hủy đặt xe thông qua ứng dụng GoTraffic theo chính sách hủy đặt của chúng tôi.
                    Vui lòng kiểm tra trang web hoặc ứng dụng để biết thêm chi tiết.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={{ fontSize: 20, color: 'black', fontWeight: '500' }}> 5. Tôi cần hỗ trợ, làm thế nào để liên hệ với đội ngũ GoTraffic?</Text>
                <Text style={[appStyle.text16, { lineHeight: 20, marginHorizontal: 10, textAlign: 'justify' }]}>
                    Đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng giúp đỡ bạn. Bạn có thể liên hệ qua phần Hỗ
                    Trợ trong ứng dụng hoặc trực tiếp qua trang web của chúng tôi.
                </Text>
            </View>

            <View style={{ marginTop: 15 }}>
                <Text style={[appStyle.text16, { lineHeight: 20 }]}>
                    Nếu bạn có thêm bất kỳ câu hỏi nào khác, đừng ngần ngại liên hệ với chúng tôi.
                    Chúng tôi sẽ luôn cố gắng hết sức để đảm bảo bạn có một trải nghiệm thuê xe tốt nhất trên GoTraffic!
                </Text>
            </View>
