...
const scaleSize = (size) => Math.round(PixelRatio.roundToNearestPixel(size * scaleWidth));
const scaleHeightSize = (size) => Math.round(PixelRatio.roundToNearestPixel(size * scaleHeight));
